...
<head>
    ...
    <![endif]-->       
    <link rel="shortcut icon" href="images/home/sc.gif">
...
<body>
					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> +27 11 234 5678</a></li>
								<li><a href="#"><i class="fa fa-envelope"></i> info@smigglechat.co.za</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
		...
		<div class="header-bottom"><!--header-bottom-->
			<div class="container">
				<div class="row">
					...
					<div class="col-sm-12">
						@include('templates.partials.search-box')
	...
	<section>
		<div class="container">
			...
			<div class="row">
				<div class="col-sm-3">
					 @include('templates.partials.left-side-menu')
				</div>
					...
					<div class="col-sm-2">
						<div class="single-widget">
							...
							<ul class="nav nav-pills nav-stacked">
								...
								<li><a href="#">Dating System</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-2">
						<div class="single-widget">
							<h2>About Smiggle Chat </h2>
							<ul class="nav nav-pills nav-stacked">
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row">
					<p class="pull-left">Copyright © 2016 Smiggle Chat All rights reserved.</p>
